...
<h2>class data update  Form</h2> 


	<cfquery name="GetRecordtoUpdate" datasource="stcenroll"> 
    SELECT * FROM class
    where class_code = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.class_code#">
</cfquery>
...
<form action="classupdate_action.cfm" method="post"> 
